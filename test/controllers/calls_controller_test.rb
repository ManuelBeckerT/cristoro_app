...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post calls_url, params: { call: { fecha_llamado: @call.fecha_llamado, fecha_retiro: @call.fecha_retiro, status: @call.status } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { fecha_llamado: @call.fecha_llamado, fecha_retiro: @call.fecha_retiro, status: @call.status } }
